...
<div class="bg-primary-default p-6 z-0 col-start-2 row-start-1 text-current place-self-center justify-self-start">
<?php 
the_title( '<h1 class="w-fit z-0  text-gigantic font-black leading-tight">', '</h1>' );?>
...
<?php the_title( '<h1 class="w-fit z-0 col-start-2 row-start-1 text-primary-default place-self-center justify-self-start text-gigantic font-black leading-tight">', '</h1>' );?>

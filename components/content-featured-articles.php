			...
			?>
				...
				<div class="relative flex rounded-md snap-center overflow-hidden shadow-md">
					...
					<?php echo get_the_post_thumbnail($item->ID, 'large', array( 'class' => 'w-full' ));?>
					 ...
					 <span class="absolute lg:min-h-[7rem] bottom-0 left-0 right-0 text-primary-default bg-dark-opacity text-primary-default px-1 py-1 lg:py-2 lg:px-2 flex items-center font-serif" > <?php echo get_the_title($item->ID);?></span>
					</a>

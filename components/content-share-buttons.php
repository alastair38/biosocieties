...
<ul class="flex gap-6 px-6 justify-center">
	<li>
		<a class="flex gap-1 items-center group" rel="nofollow" href="https://twitter.com/intent/tweet?url=<?php echo get_the_permalink(); ?>&text=<?php echo str_replace('|',"-", get_the_title() ); ?>" target="_blank" rel="noreferrer" aria-label="Share this content on Twitter"><span class="hidden md:inline-block">Twitter</span>
	...
	<li>
		<a class="flex gap-1 items-center group" rel="nofollow" href="https://www.facebook.com/sharer.php?u=<?php echo get_the_permalink(); ?>" target="_blank" rel="noreferrer" aria-label="Share this content on Facebook"><span class="hidden md:inline-block">Facebook</span>

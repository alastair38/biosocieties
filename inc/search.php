...
function blockhaus_custom_form($placeholder) {
	$form = '<form role="search" method="get" class="search-form w-1/2 text-sm leading-6 flex py-1 px-2 bg-primary-default rounded-full border border-neutral-light-100 focus-within:border-secondary gap-2" action="' . home_url( '/' ) . '">
	<label class="w-full">
